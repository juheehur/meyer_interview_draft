        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <h2 className="text-4xl lg:text-5xl font-light text-gray-900 dark:text-white mt-6 mb-6 leading-tight">
              The 6 Core Values
              <span className="block font-medium text-[#023da6]">That Guide Us</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {coreValues.map((value, index) => (
              <div key={index} className="group bg-gray-50 dark:bg-gray-800 p-8 rounded-xl hover:bg-white dark:hover:bg-gray-700 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 border border-transparent hover:border-[#023da6]/20">
